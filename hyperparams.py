...
class Hyperparams:
    '''Hyperparameters'''
    # data
    source_vocab = 'corpora/voca.src'
    target_vocab = 'corpora/voca.tgt'
    source_train = 'corpora/train_data.src'
    target_train = 'corpora/train_data.tgt'
    source_test = 'corpora/test.txt'
